...
module.exports.getMars = function Mars() {
    const mars = {
        image: 'https://assets.science.nasa.gov/dynamicimage/assets/science/psd/mars/resources/detail_files/6/6453_mars-globe-valles-marineris-enhanced-full2.jpg?w=831&h=831&fit=clip&crop=faces%2Cfocalpoint', 
...
module.exports.getJupiter = function Jupiter() {
    const jupiter = {
        image:'https://assets.science.nasa.gov/dynamicimage/assets/science/psd/solar/internal_resources/2551/Fuzzy_color_image_of_Jupiter.jpeg?w=640&h=530&fit=clip&crop=faces%2Cfocalpoint',
...
module.exports.getUranus = function Uranus() {
    const uranus = {
        image: 'https://images-assets.nasa.gov/image/PIA18182/PIA18182~orig.jpg?w=220&h=220&fit=clip&crop=faces%2Cfocalpoint',
